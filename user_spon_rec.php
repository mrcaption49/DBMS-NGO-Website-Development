...
<div class="header">
<p style="color:#ffffff; font-family:Trebuchet MS; font-size:20px"><span align="left">Sponsers Record.</span></p>
</div>
...
<div class="row">
  <div class="col-3 menu">
    <ul>
      ...
      <li class="active" ><a  href="http://localhost/ngo/user_spon_rec.php" style="text-decoration:none; color:#ffffff">Sponsers Record</li>
      
	  
	  <li><a href="http://localhost/ngo/user_act_show.php" style="text-decoration:none; color:#ffffff">New Activity</li>
