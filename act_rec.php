...
<div class="header">
<p style="color:#ffffff; font-family:Trebuchet MS; font-size:20px"><span align="left">Activity Records.</span></p>
</div>
...
<div class="row">
  <div class="col-3 menu">
    <ul>
      <li class="active"><a href="http://localhost/ngo/act_rec.php" style="text-decoration:none; color:#ffffff">Activity Record</li>
	  ...
	  <li><a href="http://localhost/ngo/act_create.php" style="text-decoration:none; color:#ffffff">Create Activity</li>
  ...
  <div class="col-9">
	...
	<?php while ($row = mysqli_fetch_array($results)){ ?>
	 <tr>
	  ...
	  <td>
	   <a style="text-decoration:none; color:#000000" href="act_rec.php?edit=<?php echo $row['id']; ?>">Edit</a>
	  </td>
	  <td>
	   <a style="text-decoration:none; color:#000000" href="act_rec.php?del=<?php echo $row['id']; ?>">Delete</a>
	  </td>
	 </tr>
	<?php } ?>
	</tbody>
...
echo "<script>window.open('act_rec.php','_self')</script>";
}
else
{
...
mysqli_query($conn, "UPDATE ACT_REC SET name='$name', details='$detail' WHERE id='$id'");
header('location: act_rec.php');
echo "<script>window.open('act_rec.php','_self')</script>";
